...
<div class="feed-item folding feed-item-hook feed-item-2
    ...
    <div class="feed-item-inner">
        <div class="avatar">
            <a title="${feed.userName}" data-tip="p$t$amuro1230" class="zm-item-link-avatar" target="_blank"
               href="/user/${feed.userId}">
                <img src="${feed.userHead}" class="zm-item-img-avatar"></a>
        </div>
        <div class="feed-main">
                ...
                <div class="expandable entry-body">
                    <div class="zm-item-answer-author-info">
                        <a class="author-link" data-tip="p$b$amuro1230" target="_blank"
                           href="/user/${feed.userId}">${feed.userName}</a>
                        评论了该问题 ，${feed.createDate?string('yyyy-MM-dd hh:mm:ss aa')}</div>
                    <div class="zm-item-rich-text expandable js-collapse-body" data-resourceid="123114"
                         data-action="#" data-author-name="李淼" data-entry-url="#">
                        <div class="zh-summary summary clearfix">
                            <a href="/question/${feed.questionId}">${feed.questionTitle}</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="feed-item folding feed-item-hook feed-item-2
            ...
            <div class="feed-content" data-za-module="AnswerItem">
                ...
                <div class="expandable entry-body">
                    <div class="zm-item-answer-author-info">
                        <a class="author-link" data-tip="p$b$amuro1230" target="_blank"
                           href="/user/${feed.userId}">${feed.userName}</a>
                        关注了该问题 ，${feed.createDate?string('yyyy-MM-dd hh:mm:ss aa')}</div>
                    <div class="zm-item-rich-text expandable js-collapse-body" data-resourceid="123114"
                         data-action="#" data-author-name="李淼" data-entry-url="#">
                        <div class="zh-summary summary clearfix">
                            <a href="/question/${feed.questionId}">${feed.questionTitle}</a>
                ...
                <div class="zu-main-feed-con navigable" data-feedtype="topstory" id="zh-question-list"
                    ...
                    <div id="js-home-feed-list" class="zh-general-list topstory clearfix"
                        ...
                        <#list feedList as feed>
                          <#if feed.type == 1>
                              <@comment_question feed=feed />
                          <#elseif feed.type == 4>
                              <@follow_question feed=feed/>
                          <#else>
                            <p>${feed.type}</p>
                          </#if>
                        </#list>
        ...
        <div class="Guide-BioEditorUsers"><p class="Guide-BioEditorDescription"> 他们是这样介绍自己的 < /p>
            <ul>
                ...
                <li class="Guide - BioEditorItem Guide - BioEditorItem--second ">
                    <img class="Guide - BioEditorAvatar " src="https: //pic2.zhimg.com/6e5a78fe9_l.jpg"
                         width="50" height="50">
    ...
    <script type="text/template"
            class="activate-dialog-template">< div class = "code-activate-view clearfix" >
    <div class="tip"> 为了正常使用牛客的提问、回答、评论和编辑功能，请绑定你的手机或邮箱。 < /div>
        <form class="send-code">
            <div class="input-wrapper">
                <label class="info" for="account">手机或邮箱：</label> <input type="text" name="account"
                                                                        class="text" placeholder="手机号或邮箱"
                                                                        required></div>
        ...
        <form class="activate">
            ...
            <div class="input-wrapper verification-code">
                <label class="info" for="digits">验证码：</label> <input type="text" name="digits" class="text"
                                                                     placeholder="6 位数验证码" maxlength="6"
                                                                     required>
    ...
    <script type="text/json" class="json-inline" data-name="env">
        ["zhihu.com", "comet.zhihu.com", false, null, false]
    </script>
